# import subprocess
# import json
# command = 'php derive -g --mnemonic="priority alpha excuse interest stairs relax curtain between ostrich keep police mix gym kitchen reopen" --cols=path,address,privkey,pubkey --format=json'
...
send_tx('BTCTEST',"mkwqRYLAfeoMJnnb5A9WegujdggyBeEPGD","mmUQuAvBYqVpKzayhaYvnJe9VuwkRdSWPu",0.001)
send_tx('ETH',"84dE630320EDB3a20fd5C93d4c86349ce0f76CB1","34F90b2dD4F0b1AD01E7cdA92EC6E5022A477887",0.001)